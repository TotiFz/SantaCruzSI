		...
		<footer class="p-4 bg-blueNav buttom-0 rounded-lg shadow md:px-6 md:py-8 ">
			<div class="sm:flex sm:items-center sm:justify-between">
				...
				<div class="flex justify-center items-center flex-wrap space-x-2">
					<Link href={'https://www.facebook.com/Santacruzservicios-103333392585364/'}>
						<button
							type="button"
							data-mdb-ripple="true"
							data-mdb-ripple-color="light"
							href="https://www.twitch.tv/frankkaster"
					...
					<Link
						href={'https://www.linkedin.com/in/worknurses-santa-cruz-servicios-integrales-sasu-782020209/'}
					>
						<button
							type="button"
							data-mdb-ripple="true"
