			...
			<div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-white border-double border-8 border-blueNav rounded-md mt-20">
				<div class="flex flex-col lg:flex-row justify-between gap-8 ">
					<div class="w-full lg:w-5/12 flex flex-col justify-center text-white">
						<h1 class="text-3xl lg:text-4xl font-bold leading-9 text-gray-50 pb-4">¿QUIENES SOMOS?</h1>
						<p class="font-normal text-base text-gray-50 leading-6">
							...
							<br />
							<br />
							Contamos con todo el equipamiento, de última generación, necesario para el cumplimiento de
							los servicios de control, seguimiento y emergencias, y con personal joven con experiencia y
							altamente capacitado para los trabajos.
							<br />
							<br />
							Además contamos con un plantel de médicos con años de experiencia y reconocida trayectoria,
							que brindan soporte y asesoramiento constante.
						</p>
					</div>
