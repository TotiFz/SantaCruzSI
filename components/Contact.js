					...
					<div class="w-full px-4 lg:w-1/2 xl:w-6/12">
						<div class="mb-12 max-w-[570px] lg:mb-0">
							...
							<div class="mb-8 flex w-full max-w-[370px]">
								...
								<div class="w-full">
									<h4 class="text-dark mb-1 text-xl font-bold">¿Donde estamos?</h4>
									<p class="text-body-color text-base">
										Av. Reyes catolicos 1679, local 2 paseo aldeano, Salta, Argentina
									</p>
								</div>
							</div>
							<div class="mb-8 flex w-full max-w-[370px]">
								...
								<div class="w-full">
									<h4 class="text-dark mb-1 text-xl font-bold">Numero Telefonico</h4>
									<p class="text-body-color text-base">(+54)3874048783</p>
								</div>
							</div>
							<div class="mb-8 flex w-full max-w-[370px]">
								<div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
								...
								<div class="w-full">
									<h4 class="text-dark mb-1 text-xl font-bold">Direccion de correo electronico</h4>
									<p class="text-body-color text-base">gerencia@worknurses.com</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="mb-6">
									<FormControl isRequired isInvalid={touched.name && !values.name} mb={5}>
										<Input
											...
											onBlur={onBlur}
										/>
										<FormErrorMessage>Por favor complete este campo</FormErrorMessage>
									</FormControl>
								</div>
								<div class="mb-6">
